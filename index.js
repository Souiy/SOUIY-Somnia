...
figlet.text("SOUIY", { font: "Standard", horizontalLayout: "default" }, (err, data) => {
  if (err) {
...
const descriptionBox = blessed.box({
  left: "center",
  width: "100%",
  content: "{center}{bold}{bright-magenta-fg}=== TIKTOK 🚀 : SOUIY (@souiy1) ==={/bright-magenta-fg}{/bold}{/center}",
  tags: true,
  style: { fg: "white" }
});
